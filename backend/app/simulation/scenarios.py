...
def get_scenario_disaster_missions(sim_time_s: float) -> List[MissionRequest]:
    """Generates 5 urgent Priority 5 emergency disaster reconnaissance requests."""
    return [
        MissionRequest(
            id="MIS-DISASTER-01",
            name="Pacific Tsunami Inundation High-Res Optical",
            target_location=GeodeticLocation(lat=-8.5069, lon=115.2625, alt=0.0),
            priority=5,
            reward=300.0,
            deadline_s=sim_time_s + 1200.0,
            duration_s=25.0,
        ...
        MissionRequest(
            id="MIS-DISASTER-02",
            name="Californian Megafire Active Thermal Front",
            target_location=GeodeticLocation(lat=38.5816, lon=-121.4944, alt=0.0),
            priority=5,
            reward=310.0,
            deadline_s=sim_time_s + 1500.0,
            duration_s=20.0,
        ...
        MissionRequest(
            id="MIS-DISASTER-03",
            name="Cascadia Subduction Zone Earthquake SAR Rupture Mapping",
            target_location=GeodeticLocation(lat=45.5152, lon=-122.6784, alt=0.0),
            priority=5,
            reward=320.0,
            deadline_s=sim_time_s + 1800.0,
            duration_s=30.0,
        ...
        MissionRequest(
            id="MIS-DISASTER-04",
            name="Typhoon Super-Eye Core Barometric InSAR",
            target_location=GeodeticLocation(lat=14.5995, lon=120.9842, alt=0.0),
            priority=5,
            reward=290.0,
            deadline_s=sim_time_s + 1400.0,
            duration_s=25.0,
            data_size_gb=16.0,
            energy_cost_wh=21.0,
            status=MissionStatus.PENDING,
        ...
        MissionRequest(
            id="MIS-DISASTER-05",
            name="Strait of Malacca Maritime Distress Search & Rescue",
            target_location=GeodeticLocation(lat=4.2105, lon=101.9758, alt=0.0),
            priority=5,
            reward=350.0,
            deadline_s=sim_time_s + 900.0,
            duration_s=20.0,
            data_size_gb=12.0,
            energy_cost_wh=18.0,
            status=MissionStatus.PENDING,
